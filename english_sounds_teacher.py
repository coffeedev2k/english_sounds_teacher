...
all = ['show_bed_boy', 'good_shoot_cure', 'pea_boat_car_tea_dog', 'cheese_june_fly_video_this_think', 'see_television_zoo_shall_hat_man', 'now_singer_love_red_wet_yes', 'here_wait_cure_boy_show_hair_my_cow', 'sheep_ship_good_shoot_here_wait', 'bed_teacher_bird_door_cure_boy_show', 'cat_up_far_on_hair_my_cow']
...
#all = ['bed_bird_boat_boy_car_cat_cheese_cow_cure_dog_door_far_fly_go_good_hair_hat_here_june_love_man_my_now_on_pea_red_see_shall_sheep_ship_shoot_show_singer_tea_teacher_television_think_this_up_video_wait_wet_yes_zoo_', 'pea_boat_tea_dog', 'cheese_june_fly_video_this', 'see_television_zoo_shall_hat', 'up_on_far_my_cow', 'now_singer_love_red_wet_yes', 'bed_teacher_bird_door_cure_boy_show', 'here_wait_cure_boy_show_hair_my_cow', 'bed_bird_boat_boy_car_cat_cheese_cow_cure_dog_door_far_fly_go_good_hair_hat_here_june_love_man_my_now_on_pea_red_see_shall_sheep_ship_shoot_show_singer_tea_teacher_television_think_this_up_video_wait_wet_yes_zoo_']
mp3_dirs = ["mp3_sounds_chart"]
